...
public final class hkr extends hkf {
    private final ifu b;
    private final String c;
    private final int d;
    private final String e;

    public hkr(ifu ifu, String str, Account account, int i, String str2) {
    ...
    public final void b(Context context) {
        try {
            ...
            throw new hjm(1793, "The component name (keyed by BaseDataClient.KEY_COMPONENT_NAME) needs to be specified in the intent.");
