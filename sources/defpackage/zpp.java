...
public class zpp extends WebViewClient {
    final /* synthetic */ RecaptchaChimeraActivity b;

    public zpp(RecaptchaChimeraActivity recaptchaChimeraActivity) {
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        recaptchaChimeraActivity.a((Runnable) new zpl(recaptchaChimeraActivity), 10, TimeUnit.SECONDS);
