...
public enum atfh implements auco {
    UNKNOWN_EVENT(0),
    LOCATION_UPDATE(179),
    VISIT_UNKNOWN(180),
    VISIT_ARRIVAL(181),
    ...
    BLE_SCAN_COLLECTION_DID_FINISH_COMPLETE(144),
    BLE_SCAN_COLLECTION_DID_CANCEL(26),
    BLE_SCAN_COLLECTION_DID_CANCEL_UNKNOWN_REASON(150),
    ...
    POLICY_COMPUTER_STATE_CHANGED(152),
    ACTIVITY_RECOGNITION_ACTIVITY_RECEIVED(153),
    ...
    RPC_REPORT_LOCATIONS_REQUEST(155),
    RPC_REPORT_LOCATIONS_SUCCESS(156),
    RPC_REPORT_LOCATIONS_FAILURE(157),
    RPC_REPORT_LOCATIONS_RETRY(158),
    RPC_GET_SETTINGS_REQUEST(159),
    ...
    RPC_DELETE_LOCATIONS_SUCCESS(176),
    ...
    KEYCHAIN_KILL_REQUEST_ADD_SUCCESS(103),
    KEYCHAIN_KILL_REQUEST_ADD_FAILURE(104),
    KEYCHAIN_KILL_REQUEST_UPDATE_SUCCESS(105),
    ...
    KEYCHAIN_RESPONSIBILITY_UPDATE_SUCCESS(112),
    ...
    DISABLE_LR_FAILURE(199),
    ONBOARDING_FLOW_ENABLE_LH_LR_SUCCESS(135),
    ONBOARDING_FLOW_ENABLE_LH_LR_FAILURE(136),
    TIMING_UNKNOWN_PROCESS(200),
    TIMING_START_TRIGGERS(201),
    TIMING_START_LOCATION_COLLECTION(202),
    DEEP_STILL_CHANGED(203),
    BAROMETER_READING(204),
    API_CALL_UNKNOWN(205),
    API_CALL_GET_REPORTING_STATE_SAFE(206),
    API_CALL_TRY_OPT_IN(207),
    API_CALL_TRY_OPT_IN_REQUEST(208),
    API_CALL_REQUEST_UPLOAD(209),
    API_CALL_CANCEL_UPLOAD(210),
    API_CALL_REPORT_PLACE(211),
    API_CALL_SEND_DATA(212),
    API_CALL_TOGGLE_PRIVATE_MODE_ON(239),
    API_CALL_TOGGLE_PRIVATE_MODE_OFF(240),
    GEO_SUPPORTED(214),
    GEO_UNSUPPORTED(215),
    LOCATION_ENABLED_FOR_GOOGLE_APPS(216),
    LOCATION_DISABLED_FOR_GOOGLE_APPS(217),
    WIFI_ALWAYS_SCAN_MODE_ENABLED(218),
    WIFI_ALWAYS_SCAN_MODE_DISABLED(219),
    ...
    BATTERY_SAVER_MODE_THRESHOLD_CHANGED(224),
    WIFI_ENABLED(225),
    WIFI_DISABLED(226),
    ...
    public final String toString() {
        return Integer.toString(this.dy);
    }
}
