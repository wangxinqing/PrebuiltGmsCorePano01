...
public final class zsv {
    ...
    private static String a(String str, boolean z) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            int F = (int) azfa.a.a().F();
            int i = 0;
            for (int length = str.length() - 1; length >= 0 && i != F; length--) {
    ...
    public static Set a(aqxs[] aqxsArr) {
        HashSet hashSet = new HashSet();
    ...
    public static Set a(aqxu[] aqxuArr) {
        boolean k = azfa.k();
        HashSet hashSet = new HashSet();
    ...
    public static Set a(aqxv[] aqxvArr) {
        HashSet hashSet = new HashSet();
    ...
    public static boolean a(aqxx aqxx, Set set) {
