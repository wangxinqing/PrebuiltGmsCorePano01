...
public final class ahnf {
    ...
    public final double a(int i, double d) {
        double d2 = (double) this.b[i];
        Double.isNaN(d2);
        double d3 = d - d2;
        double d4 = (double) this.a[i];
        Double.isNaN(d4);
        return d3 * d4;
    }
}
