        ...
        if (i != 0) {
            ...
            if (b2 < -32) {
                ...
                if (b == 0) {
                    ...
                    byte b4 = bArr[i2];
                    if (i6 >= i3) {
                        return aufv.a((int) b2, (int) b3, (int) b4);
                    }
                    byte b5 = b4;
                    i2 = i6;
                    b = b5;
                ...
                if (aufq.a(b2)) {
                    ...
                    if (!aufq.c(b2)) {
                        if (i6 < i4 - 2) {
                            int i7 = i6 + 1;
                            int i8 = i7 + 1;
                            aufq.a(b2, bArr[i6], bArr[i7], bArr[i8], cArr, i3);
                            i3 += 2;
                            r12 = i8 + 1;
                        } else {
                            throw auda.i();
                        ...
                        int i9 = i6 + 1;
                        aufq.a(b2, bArr[i6], bArr[i9], cArr, i3);
                        r12 = i9 + 1;
                        i3++;
                    } else {
                        throw auda.i();
