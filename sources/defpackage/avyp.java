...
public enum avyp {
    ...
    private avyp(String str) {
        this.aS = str;
    }

    public static avyp a(String str) {
        return (avyp) Enum.valueOf(avyp.class, str);
    }

    public static avyp b(String str) {
        if (!str.startsWith("SSL_")) {
            return a(str);
        }
        String valueOf = String.valueOf(str.substring(4));
        return a(valueOf.length() == 0 ? new String("TLS_") : "TLS_".concat(valueOf));
    }
}
