...
public final class akwr implements akwg {
    private final SemanticLocationEventRequest a;
    private final ifu b;
    private final PendingIntent c;

    public akwr(SemanticLocationEventRequest semanticLocationEventRequest, ifu ifu, PendingIntent pendingIntent) {
    ...
    public final aoei a(PlacesParams placesParams) {
        return akig.a(placesParams, true);
    }

    public final void a(Context context, akvf akvf, PlacesParams placesParams) {
        try {
            b((Status) akvf.a((Subscription) new SemanticLocationEventSubscription(this.a, placesParams, this.c)).get());
