...
class lq extends ly {
    ...
    public Typeface a(Context context, kx kxVar, Resources resources, int i) {
        ...
        while (i2 < length) {
            ...
            try {
                if (lz.a(a2, resources, kyVar.f)) {
                    String path = a2.getPath();
                    int i3 = kyVar.b;
                    boolean z = kyVar.c;
                    a();
                    if (((Boolean) c.invoke(b2, new Object[]{path, Integer.valueOf(i3), Boolean.valueOf(z)})).booleanValue()) {
                        a2.delete();
                        i2++;
                    }
                }
    ...
    public android.graphics.Typeface a(android.content.Context r3, defpackage.nc[] r4, int r5) {
        /*
            r2 = this;
            int r0 = r4.length
            r1 = 0
            if (r0 <= 0) goto L_0x0059
            nc r4 = r2.a((defpackage.nc[]) r4, (int) r5)
        ...
        L_0x002b:
            ...
            android.graphics.Typeface r3 = super.a((android.content.Context) r3, (java.io.InputStream) r5)     // Catch:{ all -> 0x003f }
        ...
        L_0x0046:
            r5 = move-exception
            defpackage.apev.a((java.lang.Throwable) r3, (java.lang.Throwable) r5)     // Catch:{ all -> 0x004b }
        L_0x004a:
        ...
        L_0x0052:
            r4 = move-exception
            defpackage.apev.a((java.lang.Throwable) r3, (java.lang.Throwable) r4)     // Catch:{ IOException -> 0x0058 }
        L_0x0056:
        ...
        L_0x0059:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.lq.a(android.content.Context, nc[], int):android.graphics.Typeface");
    }
}
