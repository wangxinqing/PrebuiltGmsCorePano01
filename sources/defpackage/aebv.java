...
public final class aebv {
    ...
    public static aebv a(Context context) {
    ...
    static final boolean a(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return a(packageInfo, a, b);
        }
        return a(packageInfo, a);
    }

    private static final boolean a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    public final boolean a(String str) {
        ...
        try {
            packageInfo = jni.b(this.d).b(str, 64);
