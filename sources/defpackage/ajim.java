...
public final class ajim implements Closeable {
    public final ajio a;
    public final Context b;
    public final Object c = new Object();
    public LevelDb d;

    public ajim(LevelDb levelDb, ajio ajio, Context context) {
        this.d = levelDb;
        this.a = ajio;
        this.b = context;
    }
    ...
    private static int a(java.lang.String r4) {
        ...
        L_0x0040:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ajim.a(java.lang.String):int");
    }

    public static final ajjs b(byte[] bArr) {
        if (bArr == null || bArr.length == 0) {
            return null;
        }
        try {
            return (ajjs) aucj.a((aucj) ajjs.g, bArr, aubs.c());
        } catch (auda e) {
    ...
    public final void a(ajil ajil, List list, long j, ajjs ajjs, String str) {
        byte[] a2 = a(ajjs, str);
        if (a2 != null) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                ajil.a(ajir.a((Account) it.next(), j, ajjs), a2);
            }
        }
    }

    public final void a(ajiq ajiq) {
        String valueOf = String.valueOf(ajiq);
        ...
        synchronized (this.c) {
            if (this.d != null) {
                ajil ajil = new ajil();
                try {
                    Iterator it = ajiq.f.iterator();
                    while (it.hasNext()) {
                        ajil.a.delete((byte[]) it.next());
                        ajil.b++;
                    }
                    a(ajil, "Delete");
                } finally {
    ...
    public final void a(Exception exc) {
        ...
        try {
            this.d.close();
            LevelDb.destroy(b("ulr_db", this.b));
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean a(defpackage.ajil r8, java.lang.String r9) {
        /*
            r7 = this;
        ...
        L_0x00b3:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ajim.a(ajil, java.lang.String):boolean");
    }
    ...
    public final boolean a(List list, ApiMetadata apiMetadata, String str) {
        synchronized (this.c) {
            ...
            try {
                ...
                ajjs.a |= 4;
                ajjs.d = jag;
                a(ajil, list, apiMetadata.b().longValue(), (ajjs) o.i(), str);
                boolean a2 = a(ajil, str);
                return a2;
            } finally {
                ajil.a();
            }
    ...
    public final byte[] a(ajjs ajjs, String str) {
        try {
            return this.a.a(ajjs.k());
