...
final class apcp {
    ...
    static void a(long[] jArr, long[] jArr2) {
    ...
    static void b(long[] jArr, long[] jArr2) {
        long j = jArr2[0];
        long j2 = jArr2[0];
        long j3 = jArr2[1];
        ...
        long j48 = jArr2[8];
        long j49 = jArr2[9];
        a(new long[]{j * j, (j2 + j2) * jArr2[1], j4 + j4, j5 + j5, (j6 * j6) + (j7 * 4 * j8) + ((j9 + j9) * jArr2[4]), j10 + j10, j17 + j17, j18 + j18, (j19 * j19) + j25 + j25, j26 + j26, j33 + j33, j34 + j34, (j35 * j35) + j39 + j39, j40 + j40, j45 + j45, j46 + j46, (j47 * j47) + (jArr2[7] * 4 * jArr2[9]), (j48 + j48) * jArr2[9], (j49 + j49) * j49}, jArr);
    }

    static void c(long[] jArr, long[] jArr2, long[] jArr3) {
        long j = jArr2[1];
        long j2 = jArr2[2];
        long j3 = jArr3[2];
    ...
    static byte[] a(long[] jArr) {
        ...
        while (i9 < i) {
            ...
            while (i10 < 9) {
                ...
                int i11 = i10 & 1;
                int i12 = e[i11];
                copyOf[i10] = ((long) d[i11]) & copyOf[i10];
                i10++;
        ...
        for (int i14 = 1; i14 < 10; i14++) {
            int i15 = (((int) copyOf[i14]) ^ d[i14 & 1]) ^ -1;
            int i16 = i15 & (i15 << 16);
            int i17 = i16 & (i16 << 8);
            int i18 = i17 & (i17 << 4);
            int i19 = i18 & (i18 << 2);
    ...
    static long[] a(byte[] bArr) {
        ...
        for (int i = 0; i < 10; i++) {
            int[] iArr = b;
            jArr[i] = ((((((long) (bArr[iArr[i]] & 255)) | (((long) (bArr[iArr[i] + 1] & 255)) << 8)) | (((long) (bArr[iArr[i] + 2] & 255)) << 16)) | (((long) (bArr[iArr[i] + 3] & 255)) << 24)) >> c[i]) & ((long) d[i & 1]);
        }
        return jArr;
    }
}
