...
public final class peh implements pjl {
    private final ifu a;
    ...
    public peh(ifu ifu, Account account, int i, int i2, LatestFootprintFilter latestFootprintFilter, afgs afgs, SyncStatus syncStatus, aeva aeva) {
        this.a = ifu;
        this.b = account;
        this.c = i;
        this.d = i2;
    ...
    public final void a() {
        ...
        Throwable th2;
        try {
            aevc a2 = this.h.a(this.b, this.c, this.d);
            try {
                b2 = a2.c().b();
