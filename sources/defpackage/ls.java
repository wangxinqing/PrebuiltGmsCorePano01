...
public class ls extends lq {
    ...
    public final Typeface a(Context context, kx kxVar, Resources resources, int i) {
        if (!a()) {
            return super.a(context, kxVar, resources, i);
        }
        Object b2 = b();
        if (b2 != null) {
            ky[] kyVarArr = kxVar.a;
            ...
            while (i2 < length) {
                ...
                int i4 = kyVar.b;
                boolean z = kyVar.c;
                if (a(context, b2, str, i3, i4, z ? 1 : 0, FontVariationAxis.fromFontVariationSettings(kyVar.d))) {
                    i2++;
                } else {
                    c(b2);
                    return null;
    ...
    public final android.graphics.Typeface a(android.content.Context r13, defpackage.nc[] r14, int r15) {
        /*
            r12 = this;
            int r0 = r14.length
            r1 = 0
            ...
            nc r14 = r12.a((defpackage.nc[]) r14, (int) r15)
        ...
        L_0x0040:
            r13 = move-exception
            defpackage.apev.a((java.lang.Throwable) r14, (java.lang.Throwable) r13)     // Catch:{ IOException -> 0x0046 }
        L_0x0044:
        ...
        L_0x0046:
            ...
            return r1
        L_0x0048:
            java.util.Map r13 = defpackage.ne.a(r13, r14)
        ...
        L_0x0055:
            ...
            int r9 = r6.c
            boolean r6 = r6.d
            java.lang.reflect.Method r10 = r12.d     // Catch:{ IllegalAccessException -> 0x0098, InvocationTargetException -> 0x0096 }
            r11 = 5
        ...
        L_0x00a0:
            ...
            android.graphics.Typeface r13 = r12.a((java.lang.Object) r2)
            if (r13 == 0) goto L_0x00b3
        ...
        L_0x00b7:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ls.a(android.content.Context, nc[], int):android.graphics.Typeface");
    }
