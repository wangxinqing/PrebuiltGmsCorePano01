...
public enum avrp implements auco {
    UNKNOWN(-1),
    ...
    TUNING_FORK(998),
    STREAMZ_GROWTH(999),
    ULEX_GAMES(ImageRequest.DEFAULT_IMAGE_TIMEOUT_MS),
    ...
    SCALED_SUPPORT_CONTENT(1323),
    SCALED_SUPPORT_CONTENT_INTERNAL(1324),
    SCHEDULE(1325),
    ...
    public static avrp a(int i) {
        switch (i) {
            ...
            case 1323:
                return SCALED_SUPPORT_CONTENT;
            case 1324:
                return SCALED_SUPPORT_CONTENT_INTERNAL;
            case 1325:
                return SCHEDULE;
            case 1326:
    ...
    public final String toString() {
        return Integer.toString(this.yv);
    }
}
