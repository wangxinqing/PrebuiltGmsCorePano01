...
public final class bpn {
    ...
    private static void a(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) {
        ...
        long j4 = j;
        if (!map.isEmpty()) {
            bpi bpi = new bpi(fileChannel, 0, j);
            bpi bpi2 = new bpi(fileChannel, j2, j3 - j2);
            ...
            try {
                byte[][] a = a(iArr, new bph[]{bpi, bpi2, bpg});
                while (i2 < i) {
                    int i4 = iArr[i2];
                    ...
                    if (arrayList.equals(arrayList2)) {
                        ...
                        if (bArr3 == null || MessageDigest.isEqual(bArr3, bArr)) {
                            ...
                            while (a9.hasRemaining()) {
                                ...
                                byte[] b2 = b(a9);
                                try {
                                    arrayList3.add(new bpl((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(b2)), b2));
    ...
    private static byte[][] a(int[] r26, defpackage.bph[] r27) {
        /*
            r0 = r26
            r1 = 0
            r3 = 0
        ...
        L_0x018d:
            goto L_0x018c
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bpn.a(int[], bph[]):byte[][]");
    }

    public static X509Certificate[][] a(FileChannel fileChannel, bpj bpj) {
        nz nzVar = new nz();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer a = a(bpj.a);
                int i = 0;
                while (a.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(a(a(a), nzVar, instance));
                ...
                } else if (!nzVar.isEmpty()) {
                    a(nzVar, fileChannel, bpj.b, bpj.c, bpj.d, bpj.e);
