...
public final class bde extends acq {
    public Drawable a;
    private int b;
    private int c;
    private int d;
    ...
    private final boolean a(View view, RecyclerView recyclerView) {
        ...
        if (!(childViewHolder instanceof bdd) || ((bdd) childViewHolder).b()) {
            if (this.d == 0) {
                return true;
            }
        ...
        if (c2 < a2) {
            ...
            return !(findViewHolderForLayoutPosition instanceof bdd) || ((bdd) findViewHolderForLayoutPosition).a();
        }
    }

    public bde(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(bdg.d);
