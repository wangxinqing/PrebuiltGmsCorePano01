...
abstract class wpx extends wpy {
    private final Resources a;
    private final String b;
    private final String c;
    private final String d;

    public wpx(Resources resources, String str, String str2, String str3) {
        this.a = resources;
        this.b = str;
        this.c = str2;
        this.d = str3;
    ...
    /* access modifiers changed from: protected */
    public abstract void a(wqt wqt, long j, String str, int i, String str2, int i2);
    ...
    public final void a(wqt wqt, Cursor cursor) {
        ...
        if (!TextUtils.isEmpty(this.b)) {
            ...
            if (columnIndex == -1) {
                xdt.b("ContactsDataHandler", "Requested column %s didn't exist in the cursor.", "_id");
                j = 0;
            } else {
