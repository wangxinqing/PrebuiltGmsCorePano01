...
public final class awbz implements awca {
    ...
    public final awam a(batf batf, boolean z) {
        return new awbx(batf, z);
    }

    public final awan a(bate bate, boolean z) {
        return new awby(bate, z);
    }
}
