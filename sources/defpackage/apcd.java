...
public final class apcd {
    public static BigInteger a(BigInteger bigInteger, boolean z, EllipticCurve ellipticCurve) {
    ...
    public static KeyPair a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) apcf.f.a("EC");
        keyPairGenerator.initialize(eCParameterSpec);
        return keyPairGenerator.generateKeyPair();
    }

    public static ECPrivateKey a(int i, byte[] bArr) {
        return (ECPrivateKey) ((KeyFactory) apcf.g.a("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), a(i)));
    }

    public static ECPublicKey a(int i, byte[] bArr, byte[] bArr2) {
        ECParameterSpec a = a(i);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        a(eCPoint, a.getCurve());
        return (ECPublicKey) ((KeyFactory) apcf.g.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, a));
    }
    ...
    static void a(ECPublicKey eCPublicKey) {
    ...
    public static byte[] a(EllipticCurve ellipticCurve, int i, ECPoint eCPoint) {
