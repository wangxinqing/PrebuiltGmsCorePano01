...
public class WebRtcAudioTrack {
    ...
    private final bayl threadChecker;
    ...
    class AudioTrackThread extends Thread {
        ...
        public void run() {
            ...
            Logging.a(WebRtcAudioTrack.TAG, valueOf.length() == 0 ? new String("AudioTrackThread") : "AudioTrackThread".concat(valueOf));
            ...
            if (WebRtcAudioTrack.this.audioTrack != null) {
                ...
                try {
                    ...
                    Logging.b(WebRtcAudioTrack.TAG, valueOf2.length() == 0 ? new String("AudioTrack.stop failed: ") : "AudioTrack.stop failed: ".concat(valueOf2));
                }
            }
        }
    ...
    WebRtcAudioTrack(long j) {
        bayl bayl = new bayl();
        this.threadChecker = bayl;
        bayl.a();
        String valueOf = String.valueOf(WebRtcAudioUtils.getThreadInfo());
        Logging.a(TAG, valueOf.length() == 0 ? new String("ctor") : "ctor".concat(valueOf));
    ...
    private boolean initPlayout(int i, int i2, double d) {
        this.threadChecker.a();
        StringBuilder sb = new StringBuilder(BUFFERS_PER_SECOND);
        ...
        sb.append(")");
        Logging.a(TAG, sb.toString());
        ByteBuffer allocateDirect = ByteBuffer.allocateDirect((i2 + i2) * (i / BUFFERS_PER_SECOND));
    ...
    public void reportWebRtcAudioTrackError(String str) {
        ...
        Logging.b(TAG, valueOf.length() == 0 ? new String("Run-time playback error: ") : "Run-time playback error: ".concat(valueOf));
    ...
    private void reportWebRtcAudioTrackInitError(String str) {
        String valueOf = String.valueOf(str);
        Logging.b(TAG, valueOf.length() == 0 ? new String("Init playout error: ") : "Init playout error: ".concat(valueOf));
        WebRtcAudioUtils.logAudioState(TAG);
        WebRtcAudioTrackErrorCallback webRtcAudioTrackErrorCallback = errorCallbackOld;
        if (webRtcAudioTrackErrorCallback != null) {
    ...
    private boolean stopPlayout() {
        ...
        if (!baym.a((Thread) this.audioThread)) {
