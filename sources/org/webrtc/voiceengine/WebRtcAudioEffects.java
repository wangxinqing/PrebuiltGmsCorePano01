...
public class WebRtcAudioEffects {
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (contains) {
            Logging.c(TAG, String.valueOf(Build.MODEL).concat(" is blacklisted for HW AEC usage!"));
        }
        return contains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (contains) {
            Logging.c(TAG, String.valueOf(Build.MODEL).concat(" is blacklisted for HW NS usage!"));
        }
        return contains;
    }
    ...
    public boolean setAEC(boolean z) {
        ...
        if (!canUseAcousticEchoCanceler()) {
            Logging.c(TAG, "Platform AEC is not supported");
    ...
    public boolean setNS(boolean z) {
        ...
        if (!canUseNoiseSuppressor()) {
            Logging.c(TAG, "Platform NS is not supported");
