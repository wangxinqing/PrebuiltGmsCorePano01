...
public class WebRtcAudioRecord {
    ...
    class AudioRecordThread extends Thread {
        ...
        public void run() {
            ...
            Logging.a(WebRtcAudioRecord.TAG, valueOf.length() == 0 ? new String("AudioRecordThread") : "AudioRecordThread".concat(valueOf));
            ...
            try {
                ...
                Logging.b(WebRtcAudioRecord.TAG, valueOf2.length() == 0 ? new String("AudioRecord.stop failed: ") : "AudioRecord.stop failed: ".concat(valueOf2));
            }
        }
    ...
    public void reportWebRtcAudioRecordError(String str) {
        ...
        Logging.b(TAG, valueOf.length() == 0 ? new String("Run-time recording error: ") : "Run-time recording error: ".concat(valueOf));
    ...
    private void reportWebRtcAudioRecordInitError(String str) {
        String valueOf = String.valueOf(str);
        Logging.b(TAG, valueOf.length() == 0 ? new String("Init recording error: ") : "Init recording error: ".concat(valueOf));
        WebRtcAudioUtils.logAudioState(TAG);
        WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback = errorCallback;
        if (webRtcAudioRecordErrorCallback != null) {
