...
public class BleDeviceIdentifier extends AbstractSafeParcelable implements myv {
    public static final Parcelable.Creator CREATOR = new nai();
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof BleDeviceIdentifier) {
            ...
            if (!this.b.equals(bleDeviceIdentifier.b) || !this.a.equals(bleDeviceIdentifier.a) || this.c != bleDeviceIdentifier.c) {
                return false;
            }
            return true;
        }
