...
public class RecaptchaChimeraActivity extends Activity {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (resultReceiver != null) {
            ...
            webView.setWebViewClient(new zpm(this));
            ...
            this.f.addJavascriptInterface(new zpo(this), "RecaptchaEmbedder");
            ...
            a();
            a((Runnable) new zpq(this), k, TimeUnit.MILLISECONDS);
    ...
    public final void b(int i2, int i3, boolean z) {
        runOnUiThread(new zph(this, i2, i3, z));
    }

    public final void a(int i2, int i3, boolean z) {
        runOnUiThread(new zpf(this, Math.min((int) (((float) i2) * this.d), this.b), Math.min((int) (((float) i3) * this.d), this.c), z));
    }
    ...
    public final void a(StringBuilder sb, String str, boolean z) {
        zqg.a(sb, "mt", String.valueOf(System.currentTimeMillis()));
        new jfx(9, new zpj(this, str, sb.toString(), z)).start();
    }
}
