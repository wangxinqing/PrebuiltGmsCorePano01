...
public final class NetworkActivityEvent {
    ...
    public String toString() {
        return String.format("[%d, %d, %d, %d, %b]", new Object[]{Long.valueOf(this.eventTimeMillis), Integer.valueOf(this.networkType), Integer.valueOf(this.tag), Integer.valueOf(this.deviceState), Boolean.valueOf(this.isNetworkActive)});
    }
}
