...
public class NetworkLatencyEvent {
    ...
    public String toString() {
        return String.format("[%d, %d, %d, %d, %d, %b]", new Object[]{Long.valueOf(this.eventTimeMillis), Long.valueOf(this.latencyMillis), Integer.valueOf(this.networkType), Integer.valueOf(this.tag), Integer.valueOf(this.deviceState), Boolean.valueOf(this.successful)});
    }
}
