...
final class CryptoUpcalls {
    ...
    private static byte[] rsaOpWithPrivateKey(PrivateKey privateKey, int i, int i2, byte[] bArr) {
        ...
        try {
            ...
            logger.logp(Level.WARNING, "com.google.android.gms.org.conscrypt.CryptoUpcalls", "rsaOpWithPrivateKey", "Preferred provider doesn't support key:", e3);
            cipher = null;
        }
        if (cipher == null) {
        ...
        try {
            ...
            sb2.append(str2);
            sb2.append(":");
            logger7.logp(level6, "com.google.android.gms.org.conscrypt.CryptoUpcalls", "rsaOpWithPrivateKey", sb2.toString(), e5);
            return null;
        }
    }
    ...
    private static byte[] signDigestWithPrivateKey(PrivateKey privateKey, byte[] bArr, String str) {
        ...
        try {
            ...
            logger4.logp(level3, "com.google.android.gms.org.conscrypt.CryptoUpcalls", "signDigestWithPrivateKey", sb.toString(), e5);
            return null;
        }
        i++;
        signature = null;
