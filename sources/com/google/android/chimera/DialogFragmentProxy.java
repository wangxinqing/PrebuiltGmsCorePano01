...
public class DialogFragmentProxy extends gc implements bje {
            ...
            if (arguments == null) {
                ...
                if (string == null) {
                    ...
                    try {
                        ...
                        this.ag = (DialogFragment) moduleActivity.getClassLoader().loadClass(string).newInstance();
                    ...
                    if (dialogFragment != null) {
                        dialogFragment.setImpl(this);
                        moduleFragment = this.ag;
                    } else {
