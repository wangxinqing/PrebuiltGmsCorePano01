...
public class ScaleFrameLayout extends FrameLayout {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        float width = layoutDirection == 1 ? ((float) getWidth()) - getPivotX() : getPivotX();
        if (scaleFrameLayout.a != 1.0f) {
            int paddingLeft = getPaddingLeft();
            float f = scaleFrameLayout.a;
            i6 = paddingLeft + ((int) ((width - (width / f)) + 0.5f));
            i5 = ((int) ((((((float) (i3 - i)) - width) / f) + width) + 0.5f)) - getPaddingRight();
        } else {
            i6 = getPaddingLeft();
        ...
        if (scaleFrameLayout.b != 1.0f) {
            ...
            i8 = paddingTop + ((int) ((pivotY - (pivotY / f2)) + 0.5f));
            i7 = ((int) ((((((float) (i4 - i2)) - pivotY) / f2) + pivotY) + 0.5f)) - getPaddingBottom();
        } else {
            i8 = getPaddingTop();
        ...
        while (i11 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i13 == 16) {
                    ...
                    i10 = (i7 - measuredHeight) - layoutParams.bottomMargin;
                }
                childAt.layout(i9, i10, measuredWidth + i9, measuredHeight + i10);
                childAt.setPivotX(width - ((float) i9));
